		  ...
		  <thead class="thead-dark">
		    ...
		    <c:forEach var="subjectClass" items="${subjectClassList}">
		            <tr>
			            ...
			            <td>
			            <a href="<%=request.getContextPath()%>/admin/TeacherAllocation?action=edit&id=<c:out value="${subjectClass.id}"></c:out>" class="btn btn-outline-primary">Edit</a>
			            <a href="<%=request.getContextPath()%>/admin/TeacherAllocation?action=delete&id=<c:out value="${subjectClass.id}"></c:out>" class="btn btn-outline-danger">Delete</a>
			            </td>
